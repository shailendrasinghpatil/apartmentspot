            ...
            return this.each(function () {
                ...
                $("li", menu).mouseenter(function () {
                    ...
                    if (isTopLevel) {
                            ...
                            if ($(this).parent().find('ul:first').length == 0) {
                                timeoutInterval = setTimeout(function () {
                                    box.stop(true, false).animate({ height: '+=0' }, 300, function () {
                                        box.parent().find('ul:first').css('display', 'block').css('top', box.height()).css('z-Index', 999).stop(true, false).slideDown(100);
                                    });
                                }, 10);
                            }
                            else {
                        ...
                        $(this).find('ul:first').css('display','block').css('z-Index', 999).stop(true, false).slideDown(100);
                    }
