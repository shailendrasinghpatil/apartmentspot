...
function scriptChangeCallback(lang, kb, context) {
    ...
    if(lang != 'english'){
    document.getElementById('cmdhelp').style.width = "20px";
    document.getElementById('cmdhelp').style.height = "20px";
    document.getElementById('cmdhelp').style.display = "block";
    document.getElementById('cmdhelp').style.float = "left";
    }
...
function showHelp(elem) {
	...
	$("#dialog-help")
	.dialog("option", "title", "Help").dialog(
			"open");    
